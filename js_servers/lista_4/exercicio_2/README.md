...
A interface web `public/index.html` será carregada automaticamente em http://localhost:3000/

A documentação em Swagger estará disponível em http://localhost:3000/api/docs
